...
- [ ] **Checkpoint, René's hands:** two zones side by side — correct one highlights and receives; dead space between them yields nothing (§8.1 items 5–6). *(s4 launch-verified 2026-08-15 — four methods added, registration ran; script: `cd ~/code/w/spikes/filedrop && go run ./s4`, steps in its `README-DRAG-TEST.md`.)*
